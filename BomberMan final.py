...
while continuer:
    ...
    if choix != 0:
        ...
        bm = Bm("images/bm_droite.png", "images/bm_gauche.png",
		"images/bm_haut.png", "images/bm_bas.png", niveau)
        bombe = Bombe(image_bombe,niveau, bm)
    ...
    while continuer_jeu:
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT:
                ...
                #touche pour poser la bombe n'est pas fonctionnelle
                elif event.key == K_b :
                    bombe.pose (bm,image_bombe, niveau)
                    niveau.afficher(fenetre)
                    time.sleep(1)
                    niveau.pose_et_destruit(bombe,bm)
        ...
        niveau.afficher(fenetre)
        fenetre.blit(bm.direction,(bm.x,bm.y))
        fenetre.blit(bombe.bombe,(bombe.x, bombe.y))
